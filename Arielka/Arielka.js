...
var cards = ["Ariel.png", "czarownica.webp", "krab.jpg", "neptun.jpeg", "rybka.jpg", "Ariel.png", "czarownica.webp", "krab.jpg", "neptun.jpeg", "rybka.jpg"];
cards = shuffle(cards);
...
function restore2Cards(nr1, nr2) {
    $('#c' + nr1).css('background-image', 'url(revers.jpg)');
    $('#c' + nr1).addClass('card-hidden');
    $('#c' + nr1).removeClass('card-face-up');

    $('#c' + nr2).css('background-image', 'url(revers.jpg)');
